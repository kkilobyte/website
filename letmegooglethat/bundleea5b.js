...
$.localize.data.lmgtfy = {
  setup: {
    ...
    share_link:    "All done! Share the link below.",
    or:            "or"
  },
  ...
  play: {
    ...
    pwnage: "Come on... Was that really so hard?",
    nice:   "It's that easy."
  },
...
$(function(){
  ...
  function googleItForThem() {
    ...
    fakeMouse.animate({
      ...
      left: (inputField.position().left + 200).px()
    }, 1500, 'swing', function(){
      inputField.focus();
    ...
    function type(string, index){
      ...
      //jg on the latest version of jquery the cursor kept being placed behind the text and wasn't moving infront, this fix makesure the cursor is at front of the text being
//typed. See here: https://stackoverflow.com/a/56719955
document.getElementById("search-input").setSelectionRange(-1, -1);
    ...
    function doneTyping(){
      ...
      fakeMouse.animate({
        ...
        left: (button.position().left + 75).px()
      }, 2000, 'swing', function(){
    ...
    function redirect(){
      ...
      var google = "https://google.gprivate.com/search.php?search?q=";

      

      //https://google.gogoprivate.com/search/____________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________________/index.php?https://www.bing.com/search?q=
      if (button.attr("id") == $("#lucky").attr("id")) {
        google = "https://letmegooglethat.com/lucky.html?q=";
      }
    ...
    function fixSafariRenderGlitch() {
      ...
      {
        inputField.blur().focus();
      }
      //jg was cauisng errror with latest jquery version 3.5.1
